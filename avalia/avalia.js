...
function dameInforme(num){
	var informe; var cantos=0;
     informe='<table id="info" width="100%" border="0"><tr><td width="8%"><strong>Nº</strong></td><td width="16%"><strong>Inicio</strong></td><td width="16%"><strong>Fin</strong></td><td width="20%"><strong>Estado</strong></td><td width="20%"><strong>intentos:</strong></td><td width="20%"><strong>puntos:</strong></td></tr>';
	var taboaAct=window.opener.taboaIntentos;
	for (i=0;i<taboaAct.length;i++){
   	   if (parseInt(window.opener.taboaIntentos[i].ind)==num){
           cantos=cantos+1;
...
var tooltip=function(){
	var id = "tt"; var top = 3; var left = 3; var maxw = 380; var speed = 10; var timer = 20; var endalpha = 95;
