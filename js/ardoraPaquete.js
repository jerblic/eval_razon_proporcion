...
taboaContidos[0]=new act("R.aritmética_ Razón geométrica","R.aritmética_ Razón geométrica","","<object width='100%' height='420' type='text/html' data='act1/act1.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("problemas razón y proporción","problemas razón y proporción","","<object width='100%' height='420' type='text/html' data='act2/act2.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("Términos desconocidos","Términos desconocidos","","<object width='100%' height='420' type='text/html' data='act3/act3.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("Término medio","Término medio","","<object width='100%' height='420' type='text/html' data='act4/act4.htm'></object>",false,"",true,false,false);
taboaContidos[4]=new act("Términos desconocidos","Términos desconocidos","","<object width='100%' height='420' type='text/html' data='act5/act5.htm'></object>",false,"",true,false,false);
